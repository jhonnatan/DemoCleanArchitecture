...
namespace DemoCleanArchitecture.Tests.Cases.WebApi.Controllers.Bank.Update
{
    ...
    public class BankControllerTests
    {
        ...
        public BankControllerTests(IBankSaveUseCase bankSaveUseCase, BankPresenter presenter, IBankWriteOnlyRepository bankWriteOnlyRepository)
        {
        ...
        {
            var input = new InputBank() { Id = BankId, Name = "BankTest", Number = "123456" };
        ...
        {
            var input = new InputBank() { Id = BankId, Name = "", Number = "123456" };
            var controller = new BankController(presenter, bankSaveUseCase);
            controller.ControllerContext.HttpContext = HttpContextBuilder.New().Build();
